...
public class GenerocEx4Wildcard {
public static void main(String[] args) {
 ...
 Course<? super Student> courseW1 = new Course<Person>("a",1); // ? == student의  hightype의 인스턴스는 모두 상속 가능
 Course<? super Student> courseW2 = new Course<Student>("a",1);
 //Course<? super Student> courserW3 = new Course<HighStudent>>("a",1);
 
 courseW0.add(new Student("a")); //courseW0에는 할수 없음.
 ...
 Course<? extends Student> courseE2 = new Course<HighStudent>("a", 5); //extends == 하위 클래스 상속가능(Student를 포함)
